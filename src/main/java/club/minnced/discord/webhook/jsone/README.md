JSON in Java [package club.minnced.discord.webhook.jsone]
===============================

[![Maven Central](https://img.shields.io/maven-central/v/club.minnced.discord.webhook.jsone/json.svg)](https://mvnrepository.com/artifact/club.minnced.discord.webhook.jsone/json)
...
JSON-java releases can be found by searching the Maven repository for groupId "club.minnced.discord.webhook.jsone"
and artifactId "json". For example:
https://search.maven.org/#search%7Cgav%7C1%7Cg%3A%22club.minnced.discord.webhook.jsone%22%20AND%20a%3A%22json%22
